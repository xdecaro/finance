...
{
    private ?FinanceService $finance=null; private ?FinanceQueryService $query=null; private ?CoreIntegrationService $core=null; private ?CrossProductIntegrationService $cross=null; private ?ReferenceLookupService $references=null; private ?FinanceReminderService $reminders=null; private ?AnalyticsSourceService $analytics=null;
    ...
    public function setReferenceLookupService(ReferenceLookupService $v):void{$this->references=$v;} public function getReferenceLookupService():ReferenceLookupService{return $this->references??throw new LogicException('Reference lookup service not initialized.');}
