<?php
namespace Xdecaro\Component\Decarofinance\Administrator\View\Dashboard;
...
final class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null): void
    {
        ...
        ToolbarHelper::title(Text::_('COM_DECAROFINANCE'), 'credit');
        $wa = $app->getDocument()->getWebAssetManager();
        $wa->getRegistry()->addExtensionRegistryFile('com_decarofinance');
        try {
            $this->coreUiActive = Factory::getContainer()->get(CoreIntegrationService::class)->enableUi($wa);
        } catch (\Throwable) {
