<?php
namespace Xdecaro\Component\Decarofinance\Administrator\View\Transfers;
...
final class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl=null): void
    {
        ...
        ToolbarHelper::title(Text::_('COM_DECAROFINANCE_TRANSFERS'),'shuffle');
        ...
        $this->items=$query->listTransfers(); $this->accounts=$query->listAccounts();
        parent::display($tpl);
    }
}
