<?php
namespace Xdecaro\Component\Decarofinance\Administrator\Model;
...
{
    public const UPDATE_SITE_URL='https://raw.githubusercontent.com/xdecaro/finance/main/updates/pkg_decarofinance.xml';
    ...
    public function getInfo(): array
    {
        ...
        if($core->getVersion()!=='' && !$core->isReferenceApiAvailable()) $warnings[]='core_api';
        ...
        return [
            ...
            'core'=>[
                ...
                'api'=>$core->isReferenceApiAvailable(),
                'ui'=>false,
                'installed'=>$core->getVersion()!=='',
            ],
    ...
    {
        $result=['site_enabled'=>false,'last_check'=>0,'latest'=>'','available'=>false];
